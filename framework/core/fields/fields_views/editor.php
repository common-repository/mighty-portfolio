    ...
    <div id="wp-{{ data.id }}-wrap" class="wp-core-ui wp-editor-wrap tmce-active">
        <div id="wp-{{ data.id }}-editor-tools" class="wp-editor-tools hide-if-no-js">
            ...
            <div class="wp-editor-tabs">
                <button type="button" id="{{ data.id }}-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="{{ data.id }}"><?php esc_html_e('Visual', 'mighty-portfolio'); ?></button>
                <button type="button" id="{{ data.id }}-html" class="wp-switch-editor switch-html" data-wp-editor-id="{{ data.id }}"><?php esc_html_e('Text', 'mighty-portfolio'); ?></button>
            </div>
        </div>
